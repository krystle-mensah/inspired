	...
	<nav class="sb-sidenav accordion sb-sidenav-dark" id="sidenavAccordion">
		<div class="sb-sidenav-menu">
			<div class="nav">
				...
				<!-- SUB CATEGORY POSTS -->
				<a class="nav-link collapsed" href="./sub_category_posts.php" data-toggle="collapse" data-target="#collapsesubCategoryPosts" aria-expanded="false" aria-controls="collapseLayouts">
					<div class="sb-nav-link-icon"><i class="fas fa-blog"></i></div>
					Sub Category Posts
					<div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
				</a>
				<!-- SUB CATEGORY DROPDOWN -->
				<div class="collapse" id="collapsesubCategoryPosts" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
					<nav class="sb-sidenav-menu-nested nav">
						<a class="nav-link" href="./sub_category_posts.php">View All sub category posts</a>
						<a class="nav-link" href="sub_category_posts.php?source=add_sub_category_post">Add sub category Posts</a>
					</nav>
				</div>
				<!-- IMAGE SLIDER -->
				<a class="nav-link collapsed" href="./slider_images.php" data-toggle="collapse" data-target="#collapseSlide" aria-expanded="false" aria-controls="collapseLayouts">
					<div class="sb-nav-link-icon"><i class="fas fa-blog"></i></div>
					Image Slider
					<div class="sb-sidenav-collapse-arrow"><i class="fas fa-angle-down"></i></div>
				</a>
