...
if(isset($_POST['submit'])){
  ...
  // Then I make a request to the database to select all from the posts table where the post tags field has data like the user input.
  ...
  $count = mysqli_num_rows($search_query);
   ...
   if($count === 0 ) {
    ...
    // else if there is data
          ...
          //$sql = $connection->query("SELECT * FROM posts"); 
